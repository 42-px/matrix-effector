...
import { AuthType, EventType, IAuthData, IContent, ICreateClientOpts, ICryptoCallbacks, IMyDevice, IRecoveryKey, ISecretStorageKeyInfo, ISendEventResponse, IStageStatus, IVerificationChannel, MatrixClient, MatrixEvent, PushRuleKind, Room, RoomMember, RoomSummary, SearchOrderBy, TimelineWindow, User, VerificationRequest } from 'matrix-js-sdk';
...
export declare const restoreKeyBackupFx: import("effector").Effect<void, void | IKeyBackupRestoreResult, Error>;

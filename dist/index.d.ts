...
import { AuthType, EventType, IContent, ICreateClientOpts, ICryptoCallbacks, ISecretStorageKeyInfo, ISendEventResponse, IStageStatus, IVerificationChannel, InteractiveAuth, MatrixClient, MatrixEvent, PushRuleKind, Room, RoomMember, RoomSummary, SearchOrderBy, TimelineWindow, User, VerificationRequest } from 'matrix-js-sdk';

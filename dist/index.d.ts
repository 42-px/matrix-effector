...
import { AuthType, EventType, IAuthData, IContent, ICreateClientOpts, ICryptoCallbacks, IMyDevice, IRecoveryKey, IRoomEncryption, ISecretStorageKeyInfo, ISendEventResponse, IStageStatus, IVerificationChannel, MatrixClient, MatrixError, MatrixEvent, PushRuleKind, Room, RoomMember, RoomSummary, SearchOrderBy, TimelineWindow, User, VerificationRequest } from 'matrix-js-sdk';
...
export declare enum RecoveryKeyOrPassphraseEnum {
...
export declare type TurnOnEcnryptionParams = {
	roomId: string;
...
export declare const turnOnEcnryptionFx: import("effector").Effect<TurnOnEcnryptionParams, void, Error>;
...
export declare type SessionInfo = IMyDevice & {
	isVerified: boolean;
...
export declare const keyVerificationFx: import("effector").Effect<void, void, Error>;
...
export declare type ConfirmResetCrossSigningFxResult = {
	result: boolean;
};
...
export declare const lossAllRecoveryKeyMethod: import("effector").Event<void>;
export declare const cancelCreateNewMethod: import("effector").Event<void>;
...
export declare const createInteractiveAuthFx: import("effector").Effect<(auth: IAuthData) => Promise<IAuthData>, void, Error>;
export declare const submitAuthDict: import("effector").Event<string>;
export declare const onNeedUserPassword: import("effector").Event<void>;
export declare const onUserPasswordError: import("effector").Event<string>;
...
export declare type DetailedKeyBackupInfo = {
...
export declare type OnBackupKeyLoadProgress = {
	stage: "fetch";
	successes: undefined;
	failures: undefined;
	total: undefined;
...
export declare const newKeyBackupFx: import("effector").Effect<void, void, Error>;
export declare const $keyBackupInfo: import("effector").Store<IKeyBackupCheck | null>;
export declare const getKeyBackupInfoFx: import("effector").Effect<void, IKeyBackupCheck, Error>;
export declare const $detailedKeyBackupInfo: import("effector").Store<DetailedKeyBackupInfo | null>;
export declare const onBackupKeyLoadProgress: import("effector").Event<OnBackupKeyLoadProgress>;
export declare const $isKeyBackupEnabled: import("effector").Store<boolean | null>;
export declare const checkBackupEnabledKeyFx: import("effector").Effect<void, boolean | null, Error>;
export declare const deleteKeyBackup: import("effector").Event<void>;
...
export declare const $deviceEd25519Key: import("effector").Store<string | null>;

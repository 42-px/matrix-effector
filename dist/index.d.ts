...
import { AuthType, EventType, IContent, ICreateClientOpts, ICryptoCallbacks, IRecoveryKey, ISecretStorageKeyInfo, ISendEventResponse, IStageStatus, IVerificationChannel, InteractiveAuth, MatrixClient, MatrixEvent, PushRuleKind, Room, RoomMember, RoomSummary, SearchOrderBy, TimelineWindow, User, VerificationRequest } from 'matrix-js-sdk';
...
export declare type SubmitAuthDictFxParams = {
	password: string;

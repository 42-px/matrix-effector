...
export declare type CurrentVerificationRequest = {
	challenge: string;
...
export declare const $currentVerificationEvent: import("effector").Store<VerificationRequest<import("matrix-js-sdk/lib/crypto/verification/request/Channel").IVerificationChannel> | null>;
export declare const setCurrentVerificationEvent: import("effector").Event<VerificationRequest<import("matrix-js-sdk/lib/crypto/verification/request/Channel").IVerificationChannel>>;
export declare const $verificationEvents: import("effector").Store<VerificationRequest<import("matrix-js-sdk/lib/crypto/verification/request/Channel").IVerificationChannel>[]>;
export declare const onVerificationRequestFx: import("effector").Effect<VerificationRequest<import("matrix-js-sdk/lib/crypto/verification/request/Channel").IVerificationChannel>, VerificationRequest<import("matrix-js-sdk/lib/crypto/verification/request/Channel").IVerificationChannel>, Error>;
export declare const updateDeviceVerification: import("effector").Event<boolean>;
